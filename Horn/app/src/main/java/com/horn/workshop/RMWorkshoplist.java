 ...
 */
public class RMWorkshoplist extends AppCompatActivity implements  GoogleApiClient.ConnectionCallbacks,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.r_m_workshoplist);
    ...
    {
        Intent intent1 = new Intent(this, RMDetail.class);
    ...
    public void search_workshop_display() {
        ...
        adapter = new RMAdapter(workshop);
    ...
    */
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppConfig.URL_RM_WORKSHOPDATA, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(RMWorkshoplist.this, error.getMessage(), Toast.LENGTH_LONG).show();
                        pDialog.dismiss();
                    }
                }) {
            ...
            protected Map<String, String> getParams() {
                smLocalStore = new SMLocalStore(RMWorkshoplist.this);
                String location = "1";
