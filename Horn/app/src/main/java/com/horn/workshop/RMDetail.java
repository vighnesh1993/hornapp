...
public class RMDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.r_m_detail);
...
//        ed.putString("currentLongitude",""+currentLongitude);
       ...
       double d2=Double.parseDouble(log);*/
        ...
        String workshopid = smLocalStore.getRMworkshopdetail_id();
        Button booknow = (Button) findViewById(R.id.book_now);
        booknow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                smLocalStore.setRMworkshopname(name);

                String offer_sm=(String.valueOf(price_detail)).replaceAll("[^\\ds.]", "");
                smLocalStore.setRMOffer_total(offer_sm);
                startActivity(new Intent(RMDetail.this, RMAppointment.class));
    ...
    public void getdetailFromDb(final String workshopid) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppConfig.URL_RM_WORKSHOPDATA, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(RMDetail.this, error.getMessage(), Toast.LENGTH_LONG).show();
                    }
                }) {
...
// make them also bold
       ...
       // offer.setText("₹ "+String.valueOf(price));
        ...
        ws_distance.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent ob=new Intent(RMDetail.this,MapsActivity.class);
